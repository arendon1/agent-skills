...
python3 domain/make-a-map/scripts/make_a_map.py "Medellín"
```
...
```python
import sys
sys.path.insert(0, "domain/make-a-map/scripts")
from make_a_map import generate_map
...
- **Privacidad:** Nominatim exige `User-Agent` identificable. El script envía
  `agent-skills/make-a-map/1.0` por defecto.