...
# Add project root to sys.path to ensure 'scripts' package is findable
...
from scripts.run_eval import find_project_root, execute_eval
...
def run_loop(
    ...
    # Initialize the LLM client (Claude, Gemini, etc.)
...
def main():
    ...
    parser.add_argument(
        "--provider",
        default=None,
        help="LLM Provider for improvement (anthropic, google, etc.)",
    )
    parser.add_argument(
