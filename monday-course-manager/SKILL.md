...
description: Administra un tablero de Monday.com específicamente diseñado para gestionar actividades académicas y cursos universitarios. Incluye estructura, flujos de trabajo y priorización.
metadata:
  version: "1.0.0"
  trit: 0
  author: agent-builder
compatibility: Requires access to a Monday.com board or capability to create/edit task lists.
---
