...
| T5 | Commit (conventional) | commit after audit | [ ] |
| T6 | Deploy to phone (`~/.agents/skills/`) + live E2E via ssh | real PDF → md on device | [ ] |
| T7 | Cleanup phone artifacts + `LESSONS.md` | no leftovers on phone | [ ] |
| T8 | Close ClickUp task (move status `complete` + comment) | task closed | [ ] |
